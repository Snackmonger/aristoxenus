...
from src.data import intervallic_canon as interval, constants, keywords
...
INTERVAL_TO_POSSIBLE_SYMBOLS_MAP = {
    ...
    interval.DIATESSARON: [CHORD_SUS_4, CHORD_4, CHORD_SUS_SHARP_3, CHORD_SHARP_3],
    ...
    interval.COMPOUND_HEMIOLION: [CHORD_FLAT_7, CHORD_SHARP_6],
    interval.COMPOUND_DITONE: [CHORD_7, CHORD_MAJ_7, CHORD_M7_UPPER, CHORD_MAJ_DELTA7],
