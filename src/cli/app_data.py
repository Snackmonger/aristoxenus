...
TOPIC_DATA = {"aristoxenus": "Description of the historical figure, Aristoxenus of Tarentum.",
              ...
              capricious names that make up abstract scale theory. 
              
              In the internal system, the heptatonic series is derived from the transformation of scale tones of the diatonic scale, 
              such that each scale is diationic with one note moved.
              ...
              canonical scale, dorian is always mode 2, etc. 
              
              The modal names are never understood as implying anything about the interval structure of the resulting scaleform; 
              they simply indicate how many degrees of rotation the form is from the canonical parent.
