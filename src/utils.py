...
def convert_to_lilypond(note_names: Sequence[str]) -> tuple[str, ...]:
    ...
    """
    # TODO: LilyPond cannot recognize notes with more than two accidentals.
    # We have to filter notes that are mis-shaped...
    ...
    for i, note_name in enumerate(note_names_):
        ...
        for k, v in {constants.SHARP_SYMBOL: "is", constants.FLAT_SYMBOL: "es"}.items():
            print(note_names_[i])
