...
by https://github.com/nficano/humps
"""
import re
...
Humpable: TypeAlias = str | Mapping[str, Any] | list[Mapping[str, Any]]

def pascalize(str_or_iter: Humpable) -> Humpable:
    """
...
def camelize(str_or_iter: Humpable) -> Humpable:
    """
...
def kebabize(str_or_iter: Humpable) -> Humpable:
    """
...
def decamelize(str_or_iter: Humpable) -> Humpable:
    """
...
def depascalize(str_or_iter: Humpable) -> Humpable:
    """
    Convert a string, dict, or list of dicts to snake case.
...
def dekebabize(str_or_iter: Humpable) -> Humpable:
    """
    Convert a string, dict, or list of dicts to snake case.
    :param str_or_iter:
        A string or iterable.
...
def is_camelcase(str_or_iter: Humpable) -> bool:
    """
...
def is_pascalcase(str_or_iter: Humpable) -> bool:
    """
...
def is_kebabcase(str_or_iter: Humpable) -> bool:
    """
    Determine if a string, dict, or list of dicts is camel case.
    :param str_or_iter:
        A string or iterable.
...
def is_snakecase(str_or_iter: Humpable) -> bool:
    """
...
def _process_keys(str_or_iter: Humpable, fn: Callable[[Humpable], Humpable]) -> Humpable:
    if isinstance(str_or_iter, list):
        return cast(list[Mapping[str, Any]], [_process_keys(k, fn) for k in str_or_iter])
        
    if isinstance(str_or_iter, Mapping):
        return cast(Mapping[str, Any], {fn(k): _process_keys(v, fn) for k, v in str_or_iter.items()})
    return str_or_iter
...
def _separate_words(string: str, separator: str="_"):
    """
